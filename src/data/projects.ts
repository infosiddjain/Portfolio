...
export const projects: Project[] = [
  ...
  },
  {
    ...
    role: "Frontend Developer",
    description:
      "Sahej Health App is a holistic, tech-enabled companion for individuals managing Type 2 diabetes. Its evidence-backed approach blends traditional medicine, psychological insights, lifestyle interventions, and advanced monitoring to empower users toward better health outcomes. (https://apps.apple.com/in/app/sahej-health-app/id6469026236)",
  },
  {
    id: "dil-ki-bhakti",
    ...
    description:
      "दिल की भक्ति is a heartfelt, digital devotional platform crafted to bring the essence of bhakti—daily aartis, bhajans, mantras, and spiritual quotes—into your everyday life in Hindi. Its core mission is to provide followers with accessible and authentic devotional content, available anytime and anywhere Dil ki Bhakti. (https://www.dilkibhakti.in)",
  },
  {
    id: "learn-ReFill",
    ...
    role: "Full Stack Developer",
    description:
      "LearnReFill is an online education platform offering expert-led classes—from multi-subject academic tutoring to coding bootcamps—delivered directly to students via laptop, ensuring flexible and accessible learning anywhere. (https://www.learnrefill.com)",
  },
  {
    id: "image-Convertor",
  ...
  },
  {
    ...
    role: "Frontend Developer",
    description:
      "Wintej is a gaming app built for enthusiasts of classic games—offering a seamless and nostalgic experience where vintage titles help players achieve quick wins. It delivers fast-paced, retro-style gameplay designed to captivate both new gamers and nostalgia-driven audiences. (https://www.wintej.com)",
  },
  {
    id: "dhanu-Coin",
    name: "Dhanu Coin Web",
  ...
  },
  {
    ...
    role: "Frontend Developer",
    description:
      "Eco Charger is a smart battery health companion that notifies you when your phone reaches 75% charge, reminding you to unplug the charger. By preventing overcharging, the app helps extend battery lifespan, improve performance, and promote eco-friendly energy use. (https://mega.nz/file/N7ZRiS6I#ovrUdYNSLZOSPnhS2zh1k-YxYX3YCujz39Tf6jgOOkc)",
  },
  {
    id: "goal-app",
    name: "Goal App",
